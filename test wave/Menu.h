...
public:
	...
	CSlider CTColorVisR; //cham
	CSlider CTColorVisG; //cham
	CSlider CTColorVisB; //cham
	...
	CSlider TColorVisR; //cham 
	CSlider TColorVisG; //cham
	CSlider TColorVisB; //cham
