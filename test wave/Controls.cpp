...
#define UI_COL_TABTEXT		Color(0, 169, 255, 255)
			...
			{
				{
					...
					Render::GradientV(a.x + 2, a.y + 2, 9, 9, Color(0, 169, 255, 255), Color(0, 0, 0, 255));
				}
			}
				...
				{
					{
						...
						Render::GradientV(a.x + 2, a.y + 2, 9, 9, Color(0, 169, 255, 255), Color(0, 169, 255, 255));
					}
				}
						...
						{
							{
								...
								Render::GradientV(a.x + 2, a.y + 2, 9, 9, Color(0, 169, 255, 255), Color(169, 255, 255));
							}
						}
		Render::Outline(a.x + 2, a.y + 2, 9, 9, Color(0, 169, 255, 255));
	}
}
...
void CButtonLoad::Draw(bool hover)
{
	POINT a = GetAbsolutePos();
	if (hover)
		Render::GradientV(a.x, a.y, m_iWidth, m_iHeight, Color(0, 169, 255, 255), Color(0, 0, 0, 255));
	else
		Render::GradientV(a.x, a.y, m_iWidth, m_iHeight, Color(45, 45, 45, 255), Color(45, 45, 45, 255));

	Render::Outline(a.x, a.y, m_iWidth, m_iHeight, Color(0, 169, 255, 255));
	...
	Render::Text2(TextX, TextY, Text.c_str(), Render::Fonts::Menu, Color(0, 169, 255, 255));
}
...
void CColorSlider::Draw(bool hover)
{
	...
	Render::Clear(a.x, a.y + 3, m_iWidth, 10, Color(0, 169, 255, 255));
	Render::Outline(a.x, a.y, m_iWidth, 16, Color(0, 169, 255, 255));
		...
		{
			{
				...
				Render::GradientV(a.x, a.y + 1, Location, 7, Color(169, 255, 255), Color(50, 50, 50, 255));
			}
		}
		else if (g_menu::window.ColorsTab.ControlColor.GetIndex() == 1)
			if (g_menu::window.isOpen())
			{
				{
					...
					Render::GradientV(a.x, a.y + 1, Location, 7, Color(0, 169, 255, 255), Color(0, 169, 255, 255));
				}
			}
			else if (g_menu::window.ColorsTab.ControlColor.GetIndex() == 2)
				if (g_menu::window.isOpen())
...
void CButton::Draw(bool hover)
{
	...
	if (hover)
		Render::Clear(a.x + 2, a.y + 2, m_iWidth - 4, m_iHeight - 4, Color(0, 169, 255, 255));
	else
		Render::Clear(a.x + 2, a.y + 2, m_iWidth - 4, m_iHeight - 4, Color(0, 169, 255, 255));
	...
	Render::Text(TextX, TextY, Color(0, 169, 255, 255), Render::Fonts::supremacy, Text.c_str());
}
...
void CComboBox::Draw(bool hover)
{
	...
	Render::GradientV(a.x, a.y, m_iWidth, 20, Color(0, 169, 255, 255), Color(0, 0, 0, 255));
	if (GUI.IsMouseInRegion(Region)) Render::GradientV(a.x, a.y, m_iWidth, 20, Color(0, 169, 255, 255), Color(0, 169, 255, 255));
	...
	if (Items.size() > 0)
	{
		...
		if (IsOpen)
		{
			...
			for (int i = 0; i < Items.size(); i++)
			{
				...
				{
					Render::GradientV(a.x, a.y + 20 + i * 20, m_iWidth, 20, Color(0, 169, 255, 255), Color(35, 35, 35, 255));
				}

				RECT control_textsize = Render::GetTextSize(Render::Fonts::supremacy, Items[i].c_str());
				if (i == SelectedIndex)
					Render::Text2(a.x + 10, a.y + 20 + (i * 20) + 10 - (control_textsize.bottom / 2), Items[i].c_str(), Render::Fonts::supremacy, Color(0, 169, 255, 255));
				else
					Render::Text2(a.x + 10, a.y + 20 + (i * 20) + 10 - (control_textsize.bottom / 2), Items[i].c_str(), Render::Fonts::supremacy, Color(0, 0, 0, 255));
			}
			Render::Outline(a.x, a.y + 20, m_iWidth, Items.size() * 20, Color(0, 169, 255, 255));
		}
	}
	Vertex_t Verts2[3];
	...
	Render::Polygon(3, Verts2, Color(0, 169, 255, 255));
}
...
void CTextField::Draw(bool hover)
{
	...
	Render::Text(a.x + 2, a.y + 2, Color(0, 169, 255, 255), Render::Fonts::supremacy, cstr);
}
