...
public:
	...
	{
		if (!strcmp(event->GetName(), "bullet_impact") && g_menu::window.VisualsTab.BulletTracers.GetIndex())
		{
	...
	void OnStudioRender()
	{
		if (g_menu::window.VisualsTab.BulletTracers.GetIndex() == 1) {
		...
		if (g_menu::window.VisualsTab.BulletTracers.GetIndex() == 2)
		{
			...
			dst3D = src3D + (forward *  g_menu::window.ColorsTab.BULLET_T_G.GetValue());
			...
			Render::DrawLine(src.x, src.y, dst.x, dst.y, Color(g_menu::window.ColorsTab.BULLETCT_R.GetValue(), g_menu::window.ColorsTab.BULLETCT_G.GetValue(), g_menu::window.ColorsTab.BULLETCT_B.GetValue(), 255));
			Render::DrawRect(dst.x - 3, dst.y - 3, 6, 6, Color(g_menu::window.ColorsTab.BULLET_T_R.GetValue(), g_menu::window.ColorsTab.BULLET_T_G.GetValue(), g_menu::window.ColorsTab.BULLET_T_B.GetValue(), 255));
