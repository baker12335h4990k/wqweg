...
void Hooked_RecvProxy_Viewmodel(CRecvProxyData *pData, void *pStruct, void *pOut)
{
	...
	if (g_menu::window.CSkinsTab.SkinsEnable.GetState() && pLocal)
	{
			...
			pData->m_Value.m_Int == iBowie))
		{
		    ...
		    if (g_menu::window.CSkinsTab.KnifeModel.GetIndex() == 1)
				pData->m_Value.m_Int = iBayonet;
			else if (g_menu::window.CSkinsTab.KnifeModel.GetIndex() == 2)
				pData->m_Value.m_Int = iBowie;
			else if (g_menu::window.CSkinsTab.KnifeModel.GetIndex() == 3)
				pData->m_Value.m_Int = iButterfly;
			else if (g_menu::window.CSkinsTab.KnifeModel.GetIndex() == 4)
				pData->m_Value.m_Int = iFalchion;
			else if (g_menu::window.CSkinsTab.KnifeModel.GetIndex() == 5)
				pData->m_Value.m_Int = iFlip;
			else if (g_menu::window.CSkinsTab.KnifeModel.GetIndex() == 6)
				pData->m_Value.m_Int = iGut;
			else if (g_menu::window.CSkinsTab.KnifeModel.GetIndex() == 7)
				pData->m_Value.m_Int = iHuntsman;
			else if (g_menu::window.CSkinsTab.KnifeModel.GetIndex() == 8)
				pData->m_Value.m_Int = iKarambit;
			else if (g_menu::window.CSkinsTab.KnifeModel.GetIndex() == 9)
				pData->m_Value.m_Int = iM9Bayonet;
			else if (g_menu::window.CSkinsTab.KnifeModel.GetIndex() == 10)
				pData->m_Value.m_Int = iDagger;
		}
	}
